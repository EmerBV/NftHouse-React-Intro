...
const style = {
  ...
  sortSelect: 'flex bg-[#353840] hover:bg-[#4c505c] h-[50px] rounded-[10px] border border-[#151B22] min-w-[200px] p-[12px] cursor-pointer w-full',
...
const SortPriceButton = ({ changeSortFilter, ...adverts }) => {
  return (
