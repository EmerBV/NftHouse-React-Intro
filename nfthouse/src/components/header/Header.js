...
const style = {
    ...
    navWrapper: `shadow-lg w-full h-[72px] top-0 sticky z-[110] block`,
    navContainer: `flex items-center justify-between bg-[#04111d] md:px-10 px-7`,
    logoContainer: `justify-center items-center flex mr-3`,
    //searchBar: `hidden lg:flex md:flex flex-1 bg-[#363840] rounded-[0.8rem] hover:bg-[#4c505c] items-center  text-center`,
    searchBar: `flex flex-1 w-full md:items-center md:text-center bg-[#363840] rounded-[0.8rem] hover:bg-[#4c505c] md:my-0 my-7`,
    ...
    headerItems: `md:flex justify-end items-center md:bg-[#04111d] w-full m-0`,
    //headerItem: `lg:px-4 md:px-3 font-bold text-[#c8cacd] hover:text-white cursor-pointer`,
    headerItemContainer: `md:flex m-0`,
    headerItem: `font-bold text-[#c8cacd] hover:text-white duration-500 cursor-pointer md:my-0 my-7 md:px-3 flex items-center justify-between`,
    //headerIcon: `text-[#8a939b] text-3xl font-black lg:px-4 md:px-3 hover:text-white cursor-pointer`,
    headerIconContainer: `md:flex m-0`,
    headerIcon: `text-[#8a939b] text-3xl hover:text-white duration-500 cursor-pointer md:my-0 my-7 md:px-3 flex items-center justify-between`,
