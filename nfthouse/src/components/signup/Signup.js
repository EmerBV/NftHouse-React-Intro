...
const style = {
  ...
  submitButton: 'border border-[#282b2f] bg-[#2081e2] hover:bg-[#42a0ff] p-[0.3rem] my-4 text-xl font-semibold rounded-lg cursor-pointer text-white w-[250px]'
                ...
                <div className={style.container}>
                    ...
                    <form className={style.formContainer}>
                        ...
                        <div className={style.inputWrapper}>
                            <input className={style.inputContainer} type="text" name="textInput" id="textInput" placeholder="Email" required />
                        </div>
                        <div className={style.inputWrapper}>
                            <input className={style.inputContainer} type="password" name="passwordInput" id="passwordInput" placeholder="Password" required />
                        </div>
                        <div className={style.inputWrapper}>
                            <input className={style.inputContainer} type="text" name="username" id="passwordMatchInput" placeholder="Username" required />
                        </div>
                        <div className={style.inputWrapper}>
                            <input className={style.inputContainer} type="text" name="textInput" id="textInput" placeholder="Name" required />
                        </div>
